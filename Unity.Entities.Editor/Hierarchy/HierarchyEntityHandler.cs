...
namespace Unity.Entities.Editor
{
    internal class HierarchyEntityHandler : HierarchyNodeTypeHandler, IHierarchyEditorNodeTypeHandler, Unity.Hierarchy.Editor.IHierarchySearchPropositionProvider
    {
        ...
        {
            if (m_EntityToNodeMap.IsCreated)
                m_EntityToNodeMap.Dispose();
            if (m_NodeToEntityMap.IsCreated)
                m_NodeToEntityMap.Dispose();
            if (m_EntityToPrefabTypeMap.IsCreated)
                m_EntityToPrefabTypeMap.Dispose();
            if (m_EntityToWorld.IsCreated)
        ...
        UnityEngine.UIElements.DragVisualMode IHierarchyEditorNodeTypeHandler.OnReorder(in HierarchyViewDragAndDropHandlingData data) => UnityEngine.UIElements.DragVisualMode.None;
